...
export {
  ...
  remove_effect_dom as U,
  create_element as V,
  NAMESPACE_SVG as W,
  NAMESPACE_MATHML as X,
  EFFECT_TRANSPARENT as Y,
  component_context as Z,
  lifecycle_outside_component as _,
  prop as a,
  set_selected as a0,
  listen_to_event_and_reset_event as a1,
  current_batch as a2,
  effect as a3,
  is_array as a4,
  select_multiple_invalid_value as a5,
  is as a6,
  teardown as a7,
  render_effect as a8,
  deep_read_state as a9,
  safe_not_equal as aa,
  to_style as ab,
  queue_micro_task as ac,
  block as b,
  proxy as c,
  delegate as d,
  set as e,
